...
#### **Mean of the total steps per day: `r round(mean(stepsperday))`**
#### **Median of the total steps per day: `r median(stepsperday)`**
...
#### **Answer: Interval `r steps_df$interval[index]`**  
#### **What is the average daily activity pattern?**
...
#### There are `r nacount` missing values in this data set.
...
#### **Mean of the total steps per day after imputing: 
 `r as.character(round(mean(impstepsperday)))`**
#### **Median of the total steps per day after imputing: 
 `r as.character(median(impstepsperday))`**
